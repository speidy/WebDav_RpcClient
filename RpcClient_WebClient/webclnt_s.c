...
static const SERVER_ROUTINE DefaultIfName_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Proc0_DavrCreateConnection,
    (SERVER_ROUTINE)Proc1_DavrGetCookie,
    (SERVER_ROUTINE)Proc2_DavrSetCookie,
    (SERVER_ROUTINE)Proc3_DavrDoesServerDoDav,
    (SERVER_ROUTINE)Proc4_DavrIsValidShare,
    (SERVER_ROUTINE)Proc5_DavrEnumNetUses,
    (SERVER_ROUTINE)Proc6_DavrEnumShares,
    (SERVER_ROUTINE)Proc7_DavrEnumServers,
    (SERVER_ROUTINE)Proc8_DavrGetConnection,
    (SERVER_ROUTINE)Proc9_DavrDeleteConnection,
    (SERVER_ROUTINE)Proc10_DavrCancelConnectionsToServer,
    (SERVER_ROUTINE)Proc11_DavrGetUser,
    (SERVER_ROUTINE)Proc12_DavrConnectionExist,
    (SERVER_ROUTINE)Proc13_CDavNodeFactory__BeginChildren,
    (SERVER_ROUTINE)Proc14_DavrFreeUsedDiskSpace,
    (SERVER_ROUTINE)Proc15_DavrGetTheLockOwnerOfTheFile,
    (SERVER_ROUTINE)Proc16_DavrInvalidateCache,
    (SERVER_ROUTINE)Proc17_DavrIsWebClientRunning,
    (SERVER_ROUTINE)Proc18_DavrGetServerAuthType
    };
...
static const MIDL_SERVER_INFO DefaultIfName_ServerInfo = 
    ...
    webclnt__MIDL_ProcFormatString.Format,
